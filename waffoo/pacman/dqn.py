...
def main():
    ...
    agent = chainerrl.agents.DoubleDQN(q_func, opt, rbuf, gpu=args.gpu, gamma=args.gamma,
    ...
    if args.demo:
        ...
        experiments.train_agent_with_evaluation(
            ...
            train_max_episode_len=timestep_limit, step_hooks=(hook,))
